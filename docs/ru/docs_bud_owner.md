...
Подсистема содержит все документы, с помощью которых было оформлено поступление товара на склад по заявкам в рамках доступных для вас поручений.
...
Подсистема содержит все документы, с помощью которых было оформлено списание товара со склада по заявкам в рамках доступных для вас поручений.
