...
Подсистема содержит все документы, с помощью которых было оформлено поступление товара по заявкам в рамках доступных для вас поручений.
...
Подсистема содержит все документы, с помощью которых было оформлено списание товара по заявкам в рамках доступных для вас поручений.
